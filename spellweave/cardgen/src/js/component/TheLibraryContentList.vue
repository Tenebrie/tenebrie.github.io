...
<script>
	import btnSelectAll from 'Component/LibrarySelectAllButton.vue';
	import btnUnselectAll from 'Component/LibraryUnselectAllButton.vue';
	import btnCancelSelection from 'Component/LibraryCancelSelectionButton.vue';
	import btnDelete from 'Component/LibraryDeleteButton.vue';
	import tableItem from 'Component/TheLibraryContentListItem.vue';
